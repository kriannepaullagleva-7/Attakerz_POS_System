                        ...
                        <form action="{{ route('products.update', $product) }}" method="POST">
                            ...
                            <div class="mb-3">
                                ...
                                <select class="form-select @error('category') is-invalid @enderror" 
                                    ...
                                    <option value="raw" {{ old('category', $product->category) == 'raw' ? 'selected' : '' }}>Raw Material</option>
                                    <option value="finished" {{ old('category', $product->category) == 'finished' ? 'selected' : '' }}>Finished Product</option>
                                </select>
                                @error('category')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
